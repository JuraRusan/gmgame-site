...
const EventStatistic = () => {
  ...
  return (
    <div className={classNames(styles["stat"])}>
      <h3 className={classNames(styles["inf"])}>
        Извините, статистика доступна на екранах ширина которых больше 1024px
      </h3>
      <div className={classNames(styles["box_nav"])}>
        ...
        {show && (
          <ul className={classNames(styles["nav"])}>
            <li className={classNames(styles["line"])} onClick={() => scrollToElement("element1")}>
              Шахты
            </li>
            <li className={classNames(styles["line"])} onClick={() => scrollToElement("element2")}>
              Материалы
            </li>
            <li className={classNames(styles["line"])} onClick={() => scrollToElement("element3")}>
              Новогодняя ёлка #1
            </li>
            <li className={classNames(styles["line"])} onClick={() => scrollToElement("element4")}>
              Новогодняя ёлка #2
            </li>
            <li className={classNames(styles["line"])} onClick={() => scrollToElement("element5")}>
              Новогодняя ёлка #3
            </li>
            <li className={classNames(styles["line"])} onClick={() => scrollToElement("element6")}>
              Новогодняя ёлка #4
            </li>
            <li className={classNames(styles["line"])} onClick={() => scrollToElement("element7")}>
              Новогодний шар #1
            </li>
            <li className={classNames(styles["line"])} onClick={() => scrollToElement("element8")}>
              Новогодний шар #2
            </li>
            <li className={classNames(styles["line"])} onClick={() => scrollToElement("element9")}>
              Новогодний шар #3
            </li>
            <li className={classNames(styles["line"])} onClick={() => scrollToElement("element10")}>
              Новогодний дом #1
            </li>
            <li className={classNames(styles["line"])} onClick={() => scrollToElement("element11")}>
              Новогодний дом #2
            </li>
            <li className={classNames(styles["line"])} onClick={() => scrollToElement("element12")}>
              Новогодний дом #3
            </li>
            <li className={classNames(styles["line"])} onClick={() => scrollToElement("element13")}>
              Новогодний дом #4
            </li>
            <li className={classNames(styles["line"])} onClick={() => scrollToElement("element14")}>
              Новогодний дом #5
            </li>
            <li className={classNames(styles["line"])} onClick={() => scrollToElement("element15")}>
              Новогодний дом #6
            </li>
            <li className={classNames(styles["line"])} onClick={() => scrollToElement("element16")}>
              Новогодний дом #7
            </li>
            <li className={classNames(styles["line"])} onClick={() => scrollToElement("element17")}>
              Новогодний дом #8
            </li>
            <li className={classNames(styles["line"])} onClick={() => scrollToElement("element18")}>
              Новогодний дом #9
            </li>
            <li className={classNames(styles["line"])} onClick={() => scrollToElement("element19")}>
              Новогодний дом #10
            </li>
            <li className={classNames(styles["line"])} onClick={() => scrollToElement("element20")}>
              Новогодний дом #11
            </li>
            <li className={classNames(styles["line"])} onClick={() => scrollToElement("element21")}>
              Новогодний дом #12
            </li>
            <li className={classNames(styles["line"])} onClick={() => scrollToElement("element22")}>
              Новогодний дом #13
            </li>
            <li className={classNames(styles["line"])} onClick={() => scrollToElement("element23")}>
              Новогодний дом #14
            </li>
            <li className={classNames(styles["line"])} onClick={() => scrollToElement("element24")}>
              Новогодний дом #15
            </li>
            <li className={classNames(styles["line"])} onClick={() => scrollToElement("element25")}>
              Декорации
            </li>
            <li className={classNames(styles["line"])} onClick={() => scrollToElement("element26")}>
              Портал
            </li>
            <li className={classNames(styles["line"])} onClick={() => scrollToElement("element27")}>
              Статистика игрока
            </li>
            <li className={classNames(styles["line"])} onClick={() => scrollToElement("element28")}>
              Парящие дома
            </li>
            <li className={classNames(styles["line"])} onClick={() => scrollToElement("element29")}>
              FINAL
            </li>
            <li className={classNames(styles["line"])} onClick={() => scrollToElement("element30")}>
              NO - FINAL
            </li>
          </ul>
        )}
      ...
      <div className={classNames(styles["stat_box"])}>
        <h4 ref={elementRefs.element1} className={classNames(styles["title"])}>
          Статистика кто сколько вложил ресурсов в разблокировку шахт
        </h4>
        ...
        <h4 ref={elementRefs.element2} className={classNames(styles["title"])}>
          Статистика собранных очков (блоки суммируются)
        </h4>
        ...
        <h4 ref={elementRefs.element3} className={classNames(styles["title"])}>
          Статистика вложенных ресурсов в новогоднюю ёлку #1
        </h4>
        ...
        <h4 ref={elementRefs.element4} className={classNames(styles["title"])}>
          Статистика вложенных ресурсов в новогоднюю ёлку #2
        </h4>
        <div className={classNames(styles["box_wight_3"])}>
          <div style={containerStyle}>
            <div style={gridStyle} className="ag-theme-alpine-dark">
        ...
        <h4 ref={elementRefs.element5} className={classNames(styles["title"])}>
          Статистика вложенных ресурсов в новогоднюю ёлку #3
        </h4>
        <div className={classNames(styles["box_wight_3"])}>
          <div style={containerStyle}>
            <div style={gridStyle} className="ag-theme-alpine-dark">
        ...
        <h4 ref={elementRefs.element6} className={classNames(styles["title"])}>
          Статистика вложенных ресурсов в новогоднюю ёлку #4
        </h4>
        <div className={classNames(styles["box_wight_3"])}>
          <div style={containerStyle}>
            <div style={gridStyle} className="ag-theme-alpine-dark">
        ...
        <h4 ref={elementRefs.element7} className={classNames(styles["title"])}>
          Статистика вложенных ресурсов в новогодний шар #1
        </h4>
        <div className={classNames(styles["box_wight_3"])}>
          <div style={containerStyle}>
            <div style={gridStyle} className="ag-theme-alpine-dark">
        ...
        <h4 ref={elementRefs.element8} className={classNames(styles["title"])}>
          Статистика вложенных ресурсов в новогодний шар #2
        </h4>
        <div className={classNames(styles["box_wight_3"])}>
          <div style={containerStyle}>
            <div style={gridStyle} className="ag-theme-alpine-dark">
        ...
        <h4 ref={elementRefs.element9} className={classNames(styles["title"])}>
          Статистика вложенных ресурсов в новогодний шар #3
        </h4>
        <div className={classNames(styles["box_wight_3"])}>
          <div style={containerStyle}>
            <div style={gridStyle} className="ag-theme-alpine-dark">
        ...
        <h4 ref={elementRefs.element10} className={classNames(styles["title"])}>
          Статистика вложенных ресурсов в новогодний дом #1
        </h4>
        <div className={classNames(styles["box_wight_3"])}>
          <div style={containerStyle}>
            <div style={gridStyle} className="ag-theme-alpine-dark">
        ...
        <h4 ref={elementRefs.element11} className={classNames(styles["title"])}>
          Статистика вложенных ресурсов в новогодний дом #2
        </h4>
        <div className={classNames(styles["box_wight_3"])}>
          <div style={containerStyle}>
            <div style={gridStyle} className="ag-theme-alpine-dark">
        ...
        <h4 ref={elementRefs.element12} className={classNames(styles["title"])}>
          Статистика вложенных ресурсов в новогодний дом #3
        </h4>
        <div className={classNames(styles["box_wight_3"])}>
          <div style={containerStyle}>
            <div style={gridStyle} className="ag-theme-alpine-dark">
        ...
        <h4 ref={elementRefs.element13} className={classNames(styles["title"])}>
          Статистика вложенных ресурсов в новогодний дом #4
        </h4>
        <div className={classNames(styles["box_wight_3"])}>
          <div style={containerStyle}>
            <div style={gridStyle} className="ag-theme-alpine-dark">
        ...
        <h4 ref={elementRefs.element14} className={classNames(styles["title"])}>
          Статистика вложенных ресурсов в новогодний дом #5
        </h4>
        <div className={classNames(styles["box_wight_3"])}>
          <div style={containerStyle}>
            <div style={gridStyle} className="ag-theme-alpine-dark">
        ...
        <h4 ref={elementRefs.element15} className={classNames(styles["title"])}>
          Статистика вложенных ресурсов в новогодний дом #6
        </h4>
        <div className={classNames(styles["box_wight_3"])}>
          <div style={containerStyle}>
            <div style={gridStyle} className="ag-theme-alpine-dark">
        ...
        <h4 ref={elementRefs.element16} className={classNames(styles["title"])}>
          Статистика вложенных ресурсов в новогодний дом #7
        </h4>
        <div className={classNames(styles["box_wight_3"])}>
          <div style={containerStyle}>
            <div style={gridStyle} className="ag-theme-alpine-dark">
        ...
        <h4 ref={elementRefs.element17} className={classNames(styles["title"])}>
          Статистика вложенных ресурсов в новогодний дом #8
        </h4>
        <div className={classNames(styles["box_wight_3"])}>
          <div style={containerStyle}>
            <div style={gridStyle} className="ag-theme-alpine-dark">
        ...
        <h4 ref={elementRefs.element18} className={classNames(styles["title"])}>
          Статистика вложенных ресурсов в новогодний дом #9
        </h4>
        <div className={classNames(styles["box_wight_3"])}>
          <div style={containerStyle}>
            <div style={gridStyle} className="ag-theme-alpine-dark">
        ...
        <h4 ref={elementRefs.element19} className={classNames(styles["title"])}>
          Статистика вложенных ресурсов в новогодний дом #10
        </h4>
        <div className={classNames(styles["box_wight_3"])}>
          <div style={containerStyle}>
            <div style={gridStyle} className="ag-theme-alpine-dark">
        ...
        <h4 ref={elementRefs.element20} className={classNames(styles["title"])}>
          Статистика вложенных ресурсов в новогодний дом #11
        </h4>
        <div className={classNames(styles["box_wight_3"])}>
          <div style={containerStyle}>
            <div style={gridStyle} className="ag-theme-alpine-dark">
        ...
        <h4 ref={elementRefs.element21} className={classNames(styles["title"])}>
          Статистика вложенных ресурсов в новогодний дом #12
        </h4>
        <div className={classNames(styles["box_wight_3"])}>
          <div style={containerStyle}>
            <div style={gridStyle} className="ag-theme-alpine-dark">
        ...
        <h4 ref={elementRefs.element22} className={classNames(styles["title"])}>
          Статистика вложенных ресурсов в новогодний дом #13
        </h4>
        <div className={classNames(styles["box_wight_3"])}>
          <div style={containerStyle}>
            <div style={gridStyle} className="ag-theme-alpine-dark">
        ...
        <h4 ref={elementRefs.element23} className={classNames(styles["title"])}>
          Статистика вложенных ресурсов в новогодний дом #14
        </h4>
        <div className={classNames(styles["box_wight_3"])}>
          <div style={containerStyle}>
            <div style={gridStyle} className="ag-theme-alpine-dark">
        ...
        <h4 ref={elementRefs.element24} className={classNames(styles["title"])}>
          Статистика вложенных ресурсов в новогодний дом #15
        </h4>
        <div className={classNames(styles["box_wight_3"])}>
          <div style={containerStyle}>
            <div style={gridStyle} className="ag-theme-alpine-dark">
        ...
        <h4 ref={elementRefs.element25} className={classNames(styles["title"])}>
          Статистика вложенных ресурсов в окружающие декорации новогодней деревушки
        </h4>
        <div className={classNames(styles["box_wight_3"])}>
          <div style={containerStyle}>
            <div style={gridStyle} className="ag-theme-alpine-dark">
        ...
        <h4 ref={elementRefs.element26} className={classNames(styles["title"])}>
          Статистика вложенных ресурсов в портал
        </h4>
        <div className={classNames(styles["box_wight_3"])}>
          <div style={containerStyle}>
            <div style={gridStyle} className="ag-theme-alpine-dark">
        ...
        <h4 ref={elementRefs.element27} className={classNames(styles["title"])}>
          Статистика исключительно игрока
        </h4>
        ...
        <h4 ref={elementRefs.element28} className={classNames(styles["title"])}>
          Статистика сколько раз было доставленно новогоднее чудо
        </h4>
        ...
        <h4 ref={elementRefs.element29} className={classNames(styles["title"])}>
          Финальная итоговая статистика победителей
        </h4>
        ...
        <h4 ref={elementRefs.element30} className={classNames(styles["title"])}>
          Исключенные игроки из финальной статистики
        </h4>
        <div className={classNames(styles["box_wight_6"])}>
          <div style={containerStyle}>
            <div style={gridStyle} className="ag-theme-alpine-dark">
