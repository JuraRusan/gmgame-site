...
const Shopkeepers = () => {
  ...
  function shopFunction (props) {
    setInfoShopName(props.name_shops);
  ...
  const data = [
    {
      "id": "cb138809-c7d1-411c-8a5f-c8c081b4bbf3",
      "profession": "cleric",
      "villager_type": "savanna",
      "name_shops": "Магазин Бакси",
      "owner_name": "Бакси",
    ...
    {
      "id": "5c4f4f4a-9420-48b7-9861-f0a907666d06",
      "profession": "nitwit",
      "villager_type": "plains",
      "name_shops": "Кузнечный магазин",
