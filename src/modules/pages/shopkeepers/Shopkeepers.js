...
const Shopkeepers = () => {
  ...
  useMemo(() => {
    ...
    let filteredData = [];
    resParams.data.forEach(shop => {
      const [goods] = lodash.chain(shop.offers)
        .partition((e) => {
        ...
        <div className="shop-one-suggestions">
          ...
          <div className="villager-shop-info">
            <div className="villager-info">
              ...
              <h4 className="h4-style">Discord: <span className="span-custom-color font-custom-2">Неизвестно</span></h4>
              ...
              <h4 className="h4-style">Осталось предметов в наличии: <span className="span-custom-color font-custom-2">Неизвестно</span></h4>
            ...
            <div className="villager-img">
              ...
              <LazyLoadImage effect="blur" className="margin-top-img" src={`./site_assets/villager/webp/${infoVillagerType}_${infoProfession}.webp`} width="100%" height="100%" alt="none"/>
            </div>
          </div>
        </div>
      </div>
