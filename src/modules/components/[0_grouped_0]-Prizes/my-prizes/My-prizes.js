...
const MyPrizes = () => {
  ...
  return (
    <div className="box-prizes">
      ...
      <a target="_blank" className="prizes-link" rel="noreferrer" href="https://discord.gg/AesVsdPsFj">Если у Вас нет выигрышей, примите участие в розыгрыше на мониторинге &#129133;</a>
    </div>
  );
};
