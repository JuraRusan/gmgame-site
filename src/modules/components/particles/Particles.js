...
function createParticle(x, y, type) {
  ...
  switch (type) {
    ...
    case 'dislike':
      ...
      break;
    case 'negative':
      particle.style.backgroundImage = 'url(https://symbl-world.akamaized.net/i/webp/80/864630847478ce2ab483c21c52d1a2.webp)';
      break;
    case 'shadow':
...
function Particles({text, type}) {
  ...
  return (
    <span className={`particleBTN btn-${type}`} onClick={handleClick}>{text}</span>
  );
}
