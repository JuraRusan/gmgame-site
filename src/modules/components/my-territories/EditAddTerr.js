...
const EditAddTerr = (params) => {
    ...
    const saveMarker = () => {
        const response = sendRequest(
            ...
            'POST',
            {server: formServer, name: formName, startX: formXStart, stopX: formXStop, startZ: formZStart, stopZ: formZStop, terrID: id}
        )
            ...
            <div className="colums-add-1">
                ...
                <div className="block-row">
                    <div className="col-row-custom">
                        <h5 className="input-name font-custom-2">StartX</h5>
                        <input className="input-str-custom font-custom-2" defaultValue={formXStart} onChange={(e) => setFormXStart(e.target.value)} />
                    </div>
                    <div className="col-row-custom">
                        <h5 className="input-name font-custom-2">StopX</h5>
                        <input className="input-str-custom font-custom-2" defaultValue={formXStop} onChange={(e) => setFormXStop(e.target.value)} />
                    </div>
                    <div className="col-row-custom">
                        <h5 className="input-name font-custom-2">StartZ</h5>
                        <input className="input-str-custom font-custom-2" defaultValue={formZStart} onChange={(e) => setFormZStart(e.target.value)} />
                    </div>
                    <div className="col-row-custom">
                        <h5 className="input-name font-custom-2">StopZ</h5>
                        <input className="input-str-custom font-custom-2" defaultValue={formZStop} onChange={(e) => setFormZStop(e.target.value)} />
                    </div>
                </div>
