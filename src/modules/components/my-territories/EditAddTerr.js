        ...
        <div className="coord">
          ...
          <div className="block-row">
            <div className="col-row-custom">
              ...
              <input className="input-str-custom font-custom-2" defaultValue={formXStart}
                     onChange={(e) => setFormXStart(e.target.value)}/>
            </div>
            <div className="col-row-custom">
              <h5 className="input-name font-custom-2">StopX</h5>
              <input className="input-str-custom font-custom-2" defaultValue={formXStop}
                     onChange={(e) => setFormXStop(e.target.value)}/>
            </div>
          </div>
          <div className="block-row">
            <div className="col-row-custom">
              <h5 className="input-name font-custom-2">StartZ</h5>
              <input className="input-str-custom font-custom-2" defaultValue={formZStart}
                     onChange={(e) => setFormZStart(e.target.value)}/>
            </div>
            <div className="col-row-custom">
              <h5 className="input-name font-custom-2">StopZ</h5>
              <input className="input-str-custom font-custom-2" defaultValue={formZStop}
                     onChange={(e) => setFormZStop(e.target.value)}/>
            </div>
          </div>
      ...
      <div className="colums-add-2">
        {id === 'new'
          ? <iframe title="map" src="https://map.gmgame.ru/#/-7/64/-54/-4/GMGameWorld%20-%20overworld/over" width="100%"
                    height="100%"/>
          : <iframe title="map"
                    src={`https://map.gmgame.ru/#/${data.terr.xStart}/64/${data.terr.zStart}/-4/${data.terr.world_name}/over`}
